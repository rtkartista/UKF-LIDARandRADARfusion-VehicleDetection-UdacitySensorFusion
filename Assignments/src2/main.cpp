...
int main() {
  ...
  string in_file_name_ = "/home/rtk/git_projects/sfe/p5/Assignments/src2/EKF_DATA/obj_pose-laser-radar-synthetic-input.txt";
  ...
  string line;
  // set i to get only first 3 measurments (two lidar and one radar)
  int i = 0;
